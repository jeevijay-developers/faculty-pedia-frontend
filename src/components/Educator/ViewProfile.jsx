  ...
  return (
    <div className="w-full min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="lg:w-1/3">
              ...
              <div className="flex justify-center lg:justify-start mb-6">
                <div className="relative w-40 h-40 rounded-full overflow-hidden border-4 border-blue-600">
                  <Image
                    src={educatorData.profileImage.url}
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="flex items-center justify-center lg:justify-start gap-2 mb-4">
                  ...
                  <span className="text-lg font-semibold text-gray-900">{educatorData.rating}</span>
                  <span className="text-gray-600">({educatorData.reviewCount} reviews)</span>
                </div>
                ...
                <div className="flex justify-center lg:justify-start gap-3">
                  {educatorData.socials?.instagram && (
                    <a href={educatorData.socials.instagram} target="_blank" rel="noopener noreferrer">
                      <FaInstagram className="w-5 h-5 text-pink-600 hover:text-pink-700" />
                    </a>
                  )}
                  {educatorData.socials?.facebook && (
                    <a href={educatorData.socials.facebook} target="_blank" rel="noopener noreferrer">
                      <FaFacebook className="w-5 h-5 text-blue-600 hover:text-blue-700" />
                    </a>
                  )}
                  {educatorData.socials?.twitter && (
                    <a href={educatorData.socials.twitter} target="_blank" rel="noopener noreferrer">
                      <FaTwitter className="w-5 h-5 text-blue-400 hover:text-blue-500" />
                    </a>
                  )}
                  {educatorData.socials?.linkedin && (
                    <a href={educatorData.socials.linkedin} target="_blank" rel="noopener noreferrer">
                      <FaLinkedin className="w-5 h-5 text-blue-700 hover:text-blue-800" />
                    </a>
                  )}
                  {educatorData.socials?.youtube && (
                    <a href={educatorData.socials.youtube} target="_blank" rel="noopener noreferrer">
            ...
            <div className="space-y-6">
              {educatorData.qualification?.map((qual, index) => (
                <div key={index} className="border-l-4 border-green-600 pl-4">
                  <h3 className="text-lg font-semibold text-gray-900">{qual.title}</h3>
                  <p className="text-green-600 font-medium">{qual.institute}</p>
                  <p className="text-sm text-gray-600">
                    {new Date(qual.startDate).getFullYear()} - {new Date(qual.endDate).getFullYear()}
                  </p>
                </div>
              ))}
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="">
                  <div className="flex justify-between items-center py-3 border-b border-gray-100">
                    ...
                    <span className="text-lg font-semibold text-blue-600">{educatorData.specialization}</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-gray-100">
                    <span className="text-gray-600 font-medium">Classes:</span>
                    <span className="text-lg font-semibold text-gray-900">{educatorData.class}</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-gray-100">
                ...
                <div className="">
                  <div className="flex justify-between items-center py-3 border-b border-gray-100">
                    ...
                    <span className="text-lg font-semibold text-gray-900">{educatorData.yearsExperience}+ years</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-gray-100">
                    <span className="text-gray-600 font-medium">Status:</span>
                    <span className={`text-lg font-semibold ${educatorData.status === 'active' ? 'text-green-600' : 'text-red-600'}`}>
                      {educatorData.status === 'active' ? 'Active' : 'Inactive'}
                    </span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-gray-100">
                    <span className="text-gray-600 font-medium">Followers:</span>
                    <span className="text-lg font-semibold text-gray-900">{educatorData.followers?.length || 0}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            ...
            {visibleCourses < educatorData.courses.length && (
              <div className="flex justify-center mt-6">
                ...
                >
                  View More Courses
                  <span className="text-sm">({Math.min(3, educatorData.courses.length - visibleCourses)} more)</span>
                </button>
              </div>
            )}
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            ...
            {visibleWebinars < educatorData.webinars.length && (
              <div className="flex justify-center mt-6">
                ...
                >
                  View More Webinars
                  <span className="text-sm">({Math.min(3, educatorData.webinars.length - visibleWebinars)} more)</span>
                </button>
              </div>
            )}
          </div>
            ...
            {visibleTestSeries < educatorData.testSeries.length && (
              <div className="flex justify-center mt-6">
                ...
                >
                  ...
                  <span className="text-sm">({Math.min(3, educatorData.testSeries.length - visibleTestSeries)} more)</span>
                </button>
              </div>
            )}
          </div>
        ...
        {/* Statistics Summary */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Educator Summary</h2>
