...
const ProfileHeader = ({ 
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 relative">
      ...
      <div className="flex flex-col lg:flex-row gap-6 sm:gap-8">
        ...
        <div className="flex flex-col items-center lg:items-start">
          {/* Profile Image */}
          <div className="relative w-32 h-32 sm:w-36 sm:h-36 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-gray-200 dark:border-gray-700 shadow-lg mb-4">
            <Image 
              src={profileImageSrc} 
        ...
        <div className="flex-1">
          {/* Name and Rating */}
          <div className="mb-4">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mb-2 text-center lg:text-left">
              {firstName} {lastName}
            </h1>
            <div className="flex items-center gap-2 mb-3 justify-center lg:justify-start">
              <div className="flex">{renderStars(rating)}</div>
              <span className="text-base sm:text-lg font-semibold text-gray-800 dark:text-gray-200">{rating}</span>
              <span className="text-sm sm:text-base text-gray-600 dark:text-gray-400">({reviewCount} reviews)</span>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-6">
            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="min-w-0">
                <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 block">Qualification</span>
                <p className="font-semibold text-gray-800 dark:text-gray-200 text-sm sm:text-base truncate">{getHighestQualification()}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="min-w-0">
                <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 block">Experience</span>
                <p className="font-semibold text-gray-800 dark:text-gray-200 text-sm sm:text-base">{calculateExperience()}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="min-w-0">
                <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 block">Specialization</span>
                <p className="font-semibold text-gray-800 dark:text-gray-200 text-sm sm:text-base truncate">{specialization || "Not specified"}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="min-w-0">
                <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 block">Classes</span>
                <p className="font-semibold text-gray-800 dark:text-gray-200 text-sm sm:text-base">{classes ? classes.join(', ') : "XI, XII"}</p>
              </div>
            </div>
          </div>
          ...
          {exams && (
            <div className="mb-4">
              <span className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 block mb-2">Exams:</span>
        ...
        <div className="flex flex-col sm:flex-row lg:flex-col gap-4 w-full lg:w-72 xl:w-80">
          {/* Intro Video */}
          {introVideoLink && (
            <div className="relative h-40 sm:h-44 md:h-48 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden flex-1 lg:flex-none">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-white dark:bg-gray-900/90 flex items-center justify-center shadow-lg cursor-pointer hover:bg-white dark:hover:bg-gray-800 transition-colors duration-200">
                  <FaPlay className="text-gray-800 dark:text-gray-200 ml-1 w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" />
                </div>
              </div>
