    ...
    if (!webinars || webinars.length === 0) {
      return (
        <div className="text-center py-12 bg-gray-50 dark:bg-gray-800 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700">
          ...
          <p className="text-gray-500 dark:text-gray-400 font-medium">No webinars available</p>
                ...
                <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-800 overflow-hidden group h-full">
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 p-6 flex flex-col">
                      <h3 className="font-bold text-lg text-gray-800 dark:text-gray-200 capitalize group-hover:text-blue-600 transition-colors duration-300 line-clamp-2">
                        {webinar.title}
                      </h3>
                      ...
                      <div className="grid grid-cols-1 gap-2 mt-4 text-xs">
                        ...
                        <div className="flex items-center space-x-2 bg-blue-50 dark:bg-blue-900/20 p-2 rounded-lg">
                          ...
                          <span className="text-gray-700 dark:text-gray-300 truncate">{webinar.time}</span>
                        </div>
                        <div className="flex items-center space-x-2 bg-blue-50 dark:bg-blue-900/20 p-2 rounded-lg">
                      ...
                      <div className="mt-auto pt-4 flex gap-3">
                        ...
                        >
                          {webinar.isLive ? (
                            <>
                              <span className="w-2 h-2 bg-white dark:bg-gray-900 rounded-full animate-pulse mr-2"></span>
                              Join Now
                            </>
                          ) : (
                            "Register"
