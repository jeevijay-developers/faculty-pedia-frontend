                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <input
                                        ...
                                        className={`appearance-none block w-full px-3 py-3 sm:py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-sm transition-colors ${errors.email
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative">
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className={`appearance-none block w-full px-3 py-3 sm:py-2 pr-10 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-sm transition-colors ${errors.password
                                            ? 'border-red-300 text-red-900 placeholder-red-300'
                                            : 'border-gray-300 text-gray-900'
                                            }`}
