    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-8 text-center">
          <div className="text-gray-500 dark:text-gray-400">No result data available</div>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-6">
        ...
        <div className="px-6 sm:px-8 py-8 sm:py-10 text-white">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
            ...
            <div className="flex gap-3">
              <button className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-900/10 hover:bg-white dark:hover:bg-gray-800/20 rounded-lg transition-colors">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400 mb-2">out of {totalScore}</div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400 mb-2">Your Rank</div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-blue-50 dark:bg-blue-900/20 text-blue-600 mb-3">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400 mb-2">minutes</div>
            <div className="text-xs text-gray-500 dark:text-gray-400">
              Total Duration
            </div>
          </div>
        ...
        <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div className="text-center p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <div className="flex items-center justify-center w-8 h-8 bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 rounded-full mx-auto mb-2">
                <FiMinusCircle className="w-4 h-4" />
              </div>
              <div className="text-2xl font-bold text-gray-600 dark:text-gray-400 mb-1">{totalUnattempted}</div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-linear-to-r from-blue-50 to-indigo-50 rounded-lg">
              <div className="text-sm text-gray-600 dark:text-gray-400 mb-1">Percentile</div>
            ...
            {/* Subject Performance */}
            <div>
              <div className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-3">Subject: {testId?.subject}</div>
            ...
            <div className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <div className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Next Steps</div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="flex items-center justify-between p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
          <div>
            <div className="font-medium text-gray-900 dark:text-gray-100">{seriesId?.title}</div>
            <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Subject: {seriesId?.subject} • Total Tests: {seriesId?.totalTests}
            </div>
          </div>
          <div className="text-right">
            <div className="text-sm text-gray-600 dark:text-gray-400">Current Test</div>
