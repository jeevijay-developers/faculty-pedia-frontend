...
const handleSubmitTest = async () => {
  ...
  confirmAlert({
    customUI: ({ onClose }) => {
      return (
        <div className="bg-white dark:bg-gray-900 rounded-xl lg:rounded-2xl shadow-2xl p-6 lg:p-8 max-w-sm lg:max-w-md mx-auto border border-gray-100 dark:border-gray-800">
          ...
          <div className="flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:space-x-3">
            <button
              onClick={onClose}
              className="flex-1 px-4 py-2 lg:py-3 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:bg-gray-700 rounded-lg lg:rounded-xl font-medium transition-colors duration-200 text-sm lg:text-base"
            >
              Cancel
            </button>
            <button
...
if (loading) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center">
      <div className="text-center p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
        <div className="relative">
          <div className="animate-spin rounded-full h-16 w-16 border-4 border-gray-200 dark:border-gray-700 border-t-blue-600 mx-auto mb-6"></div>
...
if (error) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-50 flex items-center justify-center">
      <div className="text-center p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-red-100 max-w-md">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 lg:py-6">
        <div className="flex flex-col space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-2 line-clamp-2">{testData.description.short}</p>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-4 gap-4 lg:gap-8">
        ...
        <div className="xl:col-span-3 order-2 xl:order-1">
          <div className="bg-white dark:bg-gray-900/80 backdrop-blur-lg rounded-xl lg:rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700/50 p-4 sm:p-6 lg:p-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pt-6 lg:pt-8 border-t border-gray-200 dark:border-gray-700 gap-4 sm:gap-0">
              <button
                onClick={handlePreviousQuestion}
                disabled={currentQuestionIndex === 0}
                className="flex items-center justify-center sm:justify-start px-4 sm:px-6 py-2 sm:py-3 text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:bg-gray-800 rounded-lg lg:rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed font-medium text-sm sm:text-base"
              >
