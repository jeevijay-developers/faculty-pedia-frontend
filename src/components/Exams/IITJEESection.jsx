    ...
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100">IIT JEE Exams</h2>
          <Link
            href="/exams/iit-jee"
        ...
        <div className="relative">
          ...
          {loading ? (
            ...
            <div className="py-16 text-center text-gray-500 dark:text-gray-400">No IIT-JEE courses available right now.</div>
          ) : (
            <Swiper
              modules={[Navigation]}
