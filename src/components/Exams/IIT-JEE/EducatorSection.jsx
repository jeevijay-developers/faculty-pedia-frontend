...
import { iitJeeEducators } from '@/Data/IIT-JEE/iit-jee.data';
          ...
          {iitJeeEducators.map((educator) => (
            <SwiperSlide key={educator.id}>
              <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 h-full">
                ...
                <div className="p-5">
                  <h3 className="text-xl font-semibold text-gray-800 mb-1">{educator.name}</h3>
                  <p className="text-blue-600 font-medium mb-4">{educator.subject}</p>
                  <div className="grid grid-cols-2 gap-4 text-sm text-gray-600 mb-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <span className='text-ellipsis truncate'>{educator.specialization}</span>
                    </div>
                  </div>
                  <div className="mt-2">
                    <Link
                    ...
                    >
                      View Profile
                      <MdKeyboardArrowRight className="h-4 w-4 ml-1 transform group-hover:translate-x-1 transition-transform duration-200" />
                    </Link>
                  </div>
                </div>
              </div>
