    ...
    <section className="py-12 bg-gray-50 dark:bg-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-row justify-between items-center gap-2 mb-8">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-gray-200">1-1 Live Classes</h2>
          <Link
            href="/courses/neet/one-to-one-course"
        ...
        <div className="relative">
          ...
          >
            {neetOneToOneCourseCourses.map((course) => (
                ...
                <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden h-full flex flex-col">
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <div className="flex flex-row gap-2">
                      ...
                      <Link
                        href={`/courses/neet/one-to-one-course/${course.id}`}
                      ...
                      <Link
                        href={`/courses/neet/one-to-one-course/${course.id}/enroll`}
