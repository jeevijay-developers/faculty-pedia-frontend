...
const CardGrid = ({ count = 3 }) => (
	<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
		{Array.from({ length: count }).map((_, idx) => (
			...
			>
				<div className="relative mb-3 h-32 overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800">
		...
		<div className="min-h-screen bg-gray-50 dark:bg-gray-800">
			<div className="max-w-7xl mx-auto px-4 md:px-6 py-8 space-y-8">
				...
				<div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
					{/* Profile card */}
					<div className="lg:col-span-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-6 shadow-sm">
					...
					{/* Details + chips */}
					<div className="lg:col-span-5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-6 shadow-sm space-y-4">
					...
					<div className="lg:col-span-3 space-y-4">
						<div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-4 shadow-sm h-full flex flex-col gap-3">
							<Bar className="h-4 w-1/2" />
							<div className="flex-1 rounded-lg bg-gray-100 dark:bg-gray-800 relative overflow-hidden">
								<div className={`${shimmer} absolute inset-0 animate-pulse`} />
							</div>
							<div className="flex-1 rounded-lg bg-gray-100 dark:bg-gray-800 relative overflow-hidden">
								<div className={`${shimmer} absolute inset-0 animate-pulse`} />
