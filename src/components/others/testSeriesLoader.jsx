...
const InfoGrid = () => (
	<div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
		{Array.from({ length: 4 }).map((_, idx) => (
			<div
				key={idx}
				className="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 p-3 shadow-sm"
			>
...
const ListSection = ({ rows = 5 }) => (
	<div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm space-y-3">
	...
	return (
		<div className="min-h-screen bg-gray-50 dark:bg-gray-800">
			<div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
				{/* Hero banner */}
				<div className="relative overflow-hidden rounded-2xl h-48 bg-gray-200 dark:bg-gray-700">
