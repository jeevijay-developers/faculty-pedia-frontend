...
const SkeletonCard = ({ tall = false }) => (
	<div className="flex h-full flex-col rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm">
		<div
			className={`w-full rounded-xl bg-gray-200 dark:bg-gray-700 animate-pulse ${
				tall ? "h-36" : "h-28"
			}`}
		/>
		<div className="mt-4 space-y-3">
			...
			<div className="h-3 w-2/3 rounded-full bg-gray-200 dark:bg-gray-700 animate-pulse" />
		</div>
	</div>
);
...
const SkeletonSection = ({ titleWidth = "w-32", tallCards = false }) => (
	<div className="space-y-4">
		<div className={`h-7 ${titleWidth} rounded-full bg-gray-200 dark:bg-gray-700 animate-pulse`} />
		<SkeletonChipRow />
	...
	return (
		<div className="min-h-screen bg-gray-50 dark:bg-gray-800 py-10">
			<div className="mx-auto max-w-6xl space-y-12 px-4 sm:px-6 lg:px-8">
				<div className="relative overflow-hidden rounded-3xl bg-white dark:bg-gray-900 shadow-sm">
					...
					<div className="absolute inset-0 flex flex-col justify-center space-y-4 px-8 sm:px-12">
						...
						<div className="h-10 w-48 rounded-full bg-gray-200 dark:bg-gray-700 animate-pulse" />
						<div className="h-4 w-3/4 max-w-xl rounded-full bg-gray-200 dark:bg-gray-700 animate-pulse" />
						<SkeletonChipRow />
