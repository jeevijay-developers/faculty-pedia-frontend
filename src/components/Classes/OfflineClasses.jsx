...
const OfflineClasses = ({
    ...
    const coursesToRender = courses.length > 0 ? courses : defaultOfflineClasses;
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative px-8 lg:px-0">
                    ...
                    <button
                        onClick={prevSlide}
                        className="absolute left-0 top-1/2 transform -translate-y-1/2 -translate-x-4 lg:-translate-x-14 z-20 bg-white dark:bg-gray-900 rounded-full p-2 lg:p-3 shadow-lg hover:shadow-xl transition-all duration-300 group border border-gray-200 dark:border-gray-700"
