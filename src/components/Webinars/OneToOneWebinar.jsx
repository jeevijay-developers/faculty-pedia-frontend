        ...
        <section className="py-16 bg-white dark:bg-gray-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-between items-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100">1:1 Live Webinars</h2>
                    <Link
                        href="/webinars"
                ...
                <div className="relative">
                    ...
                    <Swiper
                        ...
                        spaceBetween={24}
                        slidesPerView={1}
                        loop={OneToOneWebinarData.length > 4}
                    ...
                    >
                        {OneToOneWebinarData.map((webinar) => (
...
export default OneToOneWebinar;
