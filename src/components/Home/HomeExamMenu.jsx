    ...
    <section className="my-20 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="text-center relative z-10">
           <div className='w-15 h-15 mx-auto mb-2 bg-white rounded-full flex items-center justify-center shadow-md'>
              <Image src="/logo/iit-logo.png" alt="IIT Icon" width={40} height={40} style={{ width: "40px", height: "auto" }} />
            </div>
            <div>IIT JEE</div>
        ...
        >
          ...
          <div className="text-center relative z-10">
           <div className='w-15 h-15 mx-auto mb-2 bg-white rounded-full flex items-center justify-center shadow-md'>
              <Image src="/logo/neet-logo.png" alt="NEET Icon" width={40} height={40} style={{ width: "40px", height: "auto" }} />
            </div>
            <div>NEET</div>
        ...
        >
          ...
          <div className="text-center relative z-10">
           <div className='w-15 h-15 mx-auto mb-2 bg-white rounded-full flex items-center justify-center shadow-md'>
              <Image src="/logo/cbse-logo.png" alt="CBSE Icon" width={40} height={40} style={{ width: "40px", height: "auto" }} />
            </div>
            <div>CBSE</div>
