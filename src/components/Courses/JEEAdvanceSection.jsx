...
import { jeeAdvanceCourseData } from '@/Data/jeeAdvanceCourseData';
...
const JEEAdvanceSection = ({
    title = "JEE Advance Courses",
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-row justify-between items-center gap-2 mb-8">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-gray-200 ">{title}</h2>
                    <Link
                        href={viewMoreLink}
                ...
                <div className="relative">
                    ...
                    <button
                        onClick={prevSlide}
                        className="absolute left-0 top-1/2 transform -translate-y-1/2 bg-transparent hover:bg-white dark:hover:bg-gray-800 z-20 rounded-full p-2 lg:p-3 shadow-lg hover:shadow-xl transition-all duration-300 group border border-gray-200 dark:border-gray-700"
                    ...
                    <button
                        onClick={nextSlide}
                        className="absolute right-0 top-1/2 transform -translate-y-1/2 bg-transparent hover:bg-white dark:hover:bg-gray-800 z-20 rounded-full p-2 lg:p-3 shadow-lg hover:shadow-xl transition-all duration-300 group border border-gray-200 dark:border-gray-700"
    ...
    return (
        <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden h-full flex flex-col">
            ...
            <div className="p-5 flex flex-col flex-grow">
                {/* Course Title */}
                <h3 className="text-lg font-bold text-gray-800 dark:text-gray-200 mb-3 leading-tight text-ellipsis truncate overflow-hidden">
                    {course.title}
                </h3>
                ...
                <div className="space-y-2 mt-auto">
                    ...
                    <div className="flex space-x-2">
                        ...
                        <Link
                            ...
                            className="flex-1 border border-blue-300 text-blue-600 hover:bg-blue-50 dark:bg-blue-900/20 py-2 px-3 rounded-md text-xs font-medium transition-colors duration-200 text-center"
                        >
                            View Profile
                        </Link>
                    </div>
...
export default JEEAdvanceSection;
