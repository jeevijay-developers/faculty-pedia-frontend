...
import { neetCourseData } from '@/Data/NEETCourseData';
...
const NEETSection = ({
    ...
    const coursesToRender = courses.length > 0 ? courses : neetCourseData;
    ...
    return (
        <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden h-full flex flex-col">
            ...
            <div className="p-5 flex flex-col flex-grow">
                {/* Course Title */}
                <h3 className="text-lg font-bold text-gray-800 mb-3 leading-tight overflow-hidden text-ellipsis truncate">
                    {course.title}
                </h3>
                {/* Description */}
