    ...
    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <section className="py-24 bg-white dark:bg-gray-900 border-y border-gray-100 dark:border-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="inline-block px-3 py-1 bg-blue-50 dark:bg-blue-900/20 rounded-lg mb-6">
            <span className="text-blue-600 font-bold text-xs uppercase tracking-widest">Our DNA</span>
          </div>

          <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-gray-100 leading-tight mb-8">
      ...
      <section className="py-24 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-gray-100 mb-5">What We Do</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service) => (
              <div
                key={service.title}
                className="group relative bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-8 shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:-translate-y-1.5 hover:shadow-[0_16px_32px_rgba(37,99,235,0.12)] transition-all duration-300 cursor-default"
              >
                ...
                <div className="relative">
                  <div className="flex items-center justify-center w-14 h-14 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-3xl mb-5 group-hover:bg-blue-100 transition-colors duration-300 shadow-sm">
                    {service.emoji}
                  </div>
      ...
      <section className="py-24 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
          <div className="inline-block px-3 py-1 bg-blue-50 dark:bg-blue-900/20 rounded-lg mb-8">
