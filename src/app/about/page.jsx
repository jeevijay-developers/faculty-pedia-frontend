...
const offerings = [
  {
    ...
    description: "Guided sessions for IIT JEE, NEET, and CBSE (6th–12th) with real-time doubt solving.",
  },
  {
    title: "Structured learning pathways",
    description: "Curated study plans, exam-focused preparation, and progress tracking tools.",
  },
  {
    title: "Verified educator profiles",
    description: "Follow, track, and learn from trusted educators dedicated to your success.",
  },
  {
    title: "Personalized student accounts",
    description: "Secure sign-up, saved progress, and insights that adapt to every learner.",
  },
  {
    title: "Mentorship & doubt support",
    description: "One-to-one help and community guidance that keeps your preparation smooth.",
  },
];
    ...
    <div className="bg-gradient-to-b from-white via-blue-50/40 to-white">
      <section className="relative overflow-hidden bg-white">
        <div className="pointer-events-none absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-[-3rem] right-[-2rem] h-80 w-80 rounded-full bg-purple-300/20 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-16 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[3fr,2fr] lg:items-center">
            <div className="space-y-7 text-gray-900">
              ...
              <h1 className="bg-gradient-to-r from-blue-700 via-indigo-800 to-purple-700 bg-clip-text text-4xl font-extrabold leading-tight text-transparent sm:text-5xl lg:text-[56px]">
                Preparing smarter for IIT JEE, NEET, and CBSE starts here
              </h1>
              <p className="max-w-2xl text-lg leading-relaxed text-gray-600">
                Faculty Pedia is a learning platform created for students from Classes 6th to 12th and droppers pursuing IIT JEE or NEET. We connect you with exceptional educators, clear guidance, and a vibrant academic community that keeps you motivated every step of the way.
              </p>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                <div className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 to-white p-6">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-blue-800/80">
                    Practice questions and tests curated with exam patterns in mind.
                  </p>
                </div>
                <div className="rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50 to-white p-6">
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-indigo-800/80">
                    Handpicked educators verified for expertise and teaching quality.
                  </p>
                </div>
                <div className="rounded-2xl border border-purple-100 bg-gradient-to-br from-purple-50 to-white p-6 sm:col-span-2">
                  <p className="text-4xl font-bold text-purple-700">Community-first</p>
                  <p className="mt-2 text-sm leading-relaxed text-purple-800/80">
                    Students and educators follow each other, interact, and grow together inside a safe academic space.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">
              Empowering learning journeys with clarity, confidence, and consistency
            </h2>
            <p className="text-gray-600">
              Faculty Pedia is built for one purpose — helping every learner prepare smarter. Whether you are stepping into middle school or pushing for a top rank as a dropper, we pair you with the right educators and resources to make progress feel achievable.
            </p>
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              <p className="text-lg font-semibold text-gray-900">
                "We believe great learning happens when students connect with the right educators."
              </p>
              <p className="mt-3 text-sm text-gray-600">
                Our community-driven ecosystem lets students and educators follow each other, interact, and stay connected — just like a social platform, but designed entirely around academics.
              </p>
            </div>
          </div>
          <div className="rounded-3xl border border-blue-100 bg-blue-50/60 p-8 shadow-inner">
            <h3 className="text-xl font-semibold text-blue-900">Our Platform Offers:</h3>
            <ul className="mt-6 space-y-5">
              {offerings.map((item) => (
                <li key={item.title} className="flex gap-4">
                  ...
                  <div>
                    <p className="text-base font-semibold text-blue-900">{item.title}</p>
                    <p className="text-sm text-blue-800/80">{item.description}</p>
                  </div>
                </li>
              ))}
            </ul>
      ...
      <section className="bg-blue-600 py-16">
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 text-white sm:px-6 lg:flex-row lg:items-center lg:px-8">
          <div className="flex-1 space-y-4">
            <h2 className="text-3xl font-bold sm:text-4xl">Your goals deserve the right guidance</h2>
            <p className="text-blue-50/80">
              We are not just building another coaching platform. We are creating a digital space where learners feel supported, heard, and empowered — every feature is crafted to bring you closer to quality teaching and help unlock your true potential.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16 text-center sm:px-6 lg:px-8">
        ...
        <p className="mt-4 text-gray-600">
          Let us help you find the mentorship, study material, and supportive community you need to achieve your dream results.
        </p>
      </section>
    </div>
  );
