        ...
        <div className="p-8 pt-10 flex flex-col items-center text-center">
          ...
          >
            ...
            <div className="flex flex-col gap-1.5 text-left group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 dark:text-slate-500 group-focus-within:text-blue-600 dark:group-focus-within:text-blue-400 transition-colors">
                  <LuShieldQuestion className="text-[20px]" />
                </div>
                <input
              ...
              <div className="flex justify-end mt-1">
                <button
                  ...
                  className="text-xs font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
            ...
            <div className="flex flex-col gap-1.5 text-left group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400 dark:text-slate-500 group-focus-within:text-blue-600 dark:group-focus-within:text-blue-400 transition-colors">
                  <LuLockKeyhole className="text-[20px]" />
                </div>
                <input
...
const ResetPassword = () => {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-slate-50"><LuLoaderCircle className="animate-spin text-blue-600 text-4xl" /></div>}>
      <ResetPasswordForm />
    </Suspense>
  );
};
