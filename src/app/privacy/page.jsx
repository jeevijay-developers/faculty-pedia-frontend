    ...
    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-50">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 pt-24 pb-20 lg:pt-32 lg:pb-28 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed mb-3">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 text-sm text-gray-500 dark:text-gray-400 font-medium">
      ...
      {/* QUICK NAV */}
      <section className="py-10 bg-gray-50 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-800">
            ...
            return (
              ...
              >
                ...
                <div className="px-8 py-6 space-y-4">
                  {section.intro && (
                    <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{section.intro}</p>
                  )}

                  {section.paragraph && (
                    <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">{section.paragraph}</p>
                  )}
                  ...
                  {section.subsections && (
                    <div className="grid sm:grid-cols-2 gap-4">
                      {section.subsections.map((sub) => (
                        <div key={sub.label} className="rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-800 p-5">
                          <p className="text-sm font-semibold text-gray-800 dark:text-gray-200 mb-3">{sub.label}</p>
                  ...
                  {section.highlight && (
                    <div className="inline-flex items-center gap-2 rounded-xl bg-blue-50 dark:bg-blue-900/20 border border-blue-100 px-5 py-3 mt-2">
      ...
      <section className="py-16 bg-white dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="mt-3 text-gray-500 dark:text-gray-400 text-sm">For any privacy-related issues or data requests:</p>
          </div>

          <div className="grid sm:grid-cols-3 gap-5 max-w-3xl mx-auto">
            <a
              href="mailto:support@facultypedia.com"
              className="flex flex-col items-center gap-3 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-800 p-6 text-center hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
            >
              <div className="flex items-center justify-center w-11 h-11 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-blue-600">
                <FiMail className="w-5 h-5" />
              </div>
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-0.5">Email</p>
                <p className="text-sm text-gray-900 dark:text-gray-100 font-semibold">support@facultypedia.com</p>
              </div>
            </a>
            <a
            ...
            <div className="flex flex-col items-center gap-3 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-800 p-6 text-center">
              <div className="flex items-center justify-center w-11 h-11 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-blue-600">
                <FiMapPin className="w-5 h-5" />
              </div>
              <div>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-0.5">Address</p>
                <p className="text-sm text-gray-900 dark:text-gray-100 font-semibold">Kota, Rajasthan, India</p>
              </div>
            </div>
          </div>
        </div>
